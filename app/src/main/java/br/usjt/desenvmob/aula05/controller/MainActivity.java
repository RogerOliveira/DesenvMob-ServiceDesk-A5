...
public class MainActivity extends Activity {
    public static final String CHAMADO = "br.usjt.desenvmob.aula03.model.chamado";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ctx = this;
        new DownloadJSONChamado().execute("http://10.71.4.134/arqsw_sdesk_a4/rest/filas",
                "http://10.71.4.134/arqsw_sdesk_a4/rest/img/");
    }

    public void buscarChamados(View view) {
        String fila = txtFila.getText().toString();
        new DownloadJSONChamado().execute("http://10.71.4.134/arqsw_sdesk_a4/rest/chamados");
    ...
    private class DownloadJSONChamado extends AsyncTask<String , Void , ArrayList<Chamado>>{
        ...
        protected ArrayList<Chamado> doInBackground(String... strings) {
            ...
            try {
                chamados =ChamadoNetwork.buscarChamados("http://10.71.4.134/arqsw_sdesk_a4_remasterized/rest/chamados");
            } catch (IOException e) {
                e.printStackTrace();
            }
